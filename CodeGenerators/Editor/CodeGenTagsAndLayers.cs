...
namespace UnityToolbag {
    public static class CodeGenTagsAndLayers {
        [MenuItem("UnityToolbag/Code Generators/Tags and Layers")]
        public static void Generate() {
            // Try to find an existing file in the project called "TagsAndLayers.cs"
            string filePath = string.Empty;
            foreach (var file in Directory.GetFiles(Application.dataPath, "*.cs", SearchOption.AllDirectories)) {
                if (Path.GetFileNameWithoutExtension(file) == "TagsAndLayers") {
                    filePath = file;
                    break;
                }
            }
            ...
            if (string.IsNullOrEmpty(filePath)) {
                string directory = EditorUtility.OpenFolderPanel("Choose location for TagsAndLayers.cs", Application.dataPath, "");
                ...
                filePath = Path.Combine(directory, "TagsAndLayers.cs");
            }
